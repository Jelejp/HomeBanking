        ...
        httpSecurity //DEL HTTP SECURITY QUE RECIBO COMO PARAMETRO ESTABLEZCO LA CONFIGURACION DE CORS QUE HICE
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers("/api/auth/current", "/api/auth/test", "/api/clients/current/accounts", "/api/clients/current/accounts/{id}", "/api/clients/current/cards", "/api/transactions/", "/api/loans").hasRole("CLIENT")
